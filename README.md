...
This package still uses **React SWC**. For a version using **React compiler** check out our other Template [Neutralino Vite React Compiler TS](https://github.com/Cloudwerk/neutralino-vite-react-compiler-ts)
